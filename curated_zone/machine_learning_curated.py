...
AmazonS3_node1770013471136 = glueContext.write_dynamic_frame.from_options(frame=Join_node1770013329753, connection_type="s3", format="json", connection_options={"path": "s3://udit-test-bucket-1/step_trainer/curated/", "compression": "snappy", "partitionKeys": []}, transformation_ctx="AmazonS3_node1770013471136")
