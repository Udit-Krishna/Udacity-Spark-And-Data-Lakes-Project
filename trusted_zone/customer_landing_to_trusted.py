...
CustomerLandingtoTrusted_node1769581748906 = glueContext.getSink(path="s3://udit-test-bucket-1/customer/trusted/", connection_type="s3", updateBehavior="UPDATE_IN_DATABASE", partitionKeys=[], enableUpdateCatalog=True, transformation_ctx="CustomerLandingtoTrusted_node1769581748906")
CustomerLandingtoTrusted_node1769581748906.setCatalogInfo(catalogDatabase="stedi",catalogTableName="customer_trusted")
CustomerLandingtoTrusted_node1769581748906.setFormat("glueparquet", compression="snappy")
CustomerLandingtoTrusted_node1769581748906.writeFrame(PrivacyFilter_node1769581702829)
job.commit()