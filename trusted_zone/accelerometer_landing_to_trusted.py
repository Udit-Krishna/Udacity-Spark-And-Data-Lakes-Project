...
DropFields_node1770013372645 = DropFields.apply(frame=Join_node1770013329753, paths=["serialnumber", "sharewithpublicasofdate", "birthday", "registrationdate", "sharewithresearchasofdate", "customername", "sharewithfriendsasofdate", "email", "lastupdatedate", "phone", "timestamp"], transformation_ctx="DropFields_node1770013372645")
...
AmazonS3_node1770013471136 = glueContext.write_dynamic_frame.from_options(frame=DropFields_node1770013372645, connection_type="s3", format="json", connection_options={"path": "s3://udit-test-bucket-1/accelerometer/trusted/", "compression": "snappy", "partitionKeys": []}, transformation_ctx="AmazonS3_node1770013471136")
